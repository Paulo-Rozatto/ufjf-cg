...
var cylinderMaterial3 = new THREE.MeshPhongMaterial({ color: 0xEEDD77 });
...
var cylinderMaterial4 = new THREE.MeshPhongMaterial({ color: 0xEEDD77 });
...
function rotateCylinder() {
  ...
  if (animationOn) {
    ...
    //
    cylinder3.matrix.multiply(mat4.makeRotationY(angle * 3)); // R1
    ...
    cylinder4.matrix.multiply(mat4.makeRotationY(angle * -3)); // R1
